...
export const KEYFRAMES = `
  ...
  @keyframes capsuleIn { from { transform: translateY(14px) scale(.92); opacity:0 } to { transform: translateY(0) scale(1); opacity:1 } }
  @keyframes capsuleOut { from { transform: translateY(0) scale(1); opacity:1 } to { transform: translateY(12px) scale(.94); opacity:0 } }

  ...
  return (
    <>
      <div style={{ padding: "18px 18px 10px" }}>
        <div style={{ fontSize: 21, fontWeight: 720, letterSpacing: -0.5, color: T.ink }}>
          Team Directory
        </div>
        <div style={{ fontSize: 12.5, color: T.sub, marginTop: 3 }}>
          On-call clinicians at your credentialed facilities
        </div>
        <input
          value={q}
          onChange={(e) => setQ(e.target.value)}
          placeholder="Search clinicians"
          style={{ ...inputStyle, borderRadius: 24, marginTop: 13 }}
        />
        <div
          style={{
            display: "flex",
          ...
          {["All", "Physicians", "Nurses"].map((s) => (
            <button
              ...
              style={{
                ...
                padding: "8px 0",
                borderRadius: 9.5,
                background: seg === s ? "#fff" : "transparent",
                boxShadow: seg === s ? "0 1px 4px rgba(11,18,32,.12)" : "none",
                fontSize: 13.5,
                fontWeight: seg === s ? 640 : 500,
                color: seg === s ? T.ink : T.sub,
      ...
      >
        {shown.length === 0 && (
          <div style={{ gridColumn: "1/-1" }}>
            <Empty title="No clinicians found" sub="Try another name or department." />
          </div>
        )}
        {shown.map((s, i) => (
          <div
            ...
            style={{
              ...
              alignItems: "center",
              gap: 13,
              animation: `rise .3s ${i * 0.03}s ease backwards`,
            }}
          >
...
export function VoiceOverlay({ onStop }) {
  return (
    ...
    >
      <div style={{ fontSize: 26, fontWeight: 720, color: T.ink, letterSpacing: -0.5 }}>
        Listening…
      </div>
      <div style={{ fontSize: 14.5, color: T.sub, marginTop: 6, textAlign: "center" }}>
        Speak clearly — ALIS AI™ is transcribing
      </div>
          ...
          {[10, 22, 14, 30, 18, 26, 12].map((h, i) => (
            <span
              ...
              style={{
                ...
                borderRadius: 2,
                background: "#A9C4FF",
                animation: `eq 1s ${i * 0.09}s ease-in-out infinite alternate`,
              }}
            />
          ))}
        </div>
        <div style={{ position: "relative", width: 130, height: 130 }}>
          ...
          <div
            style={{
              ...
              alignItems: "center",
              justifyContent: "center",
              boxShadow: "0 12px 30px rgba(240,68,56,.35)",
            }}
          >
            <svg width="38" height="38" viewBox="0 0 24 24" fill="#fff">
              <rect x="9" y="3" width="6" height="11" rx="3" />
              <path d="M6 11a6 6 0 0 0 12 0h-1.6a4.4 4.4 0 0 1-8.8 0H6Z" />
              <rect x="11.2" y="17" width="1.6" height="3.4" />
              <rect x="8.5" y="20.2" width="7" height="1.6" rx="0.8" />
            </svg>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
          {[12, 26, 18, 30, 14, 22, 10].map((h, i) => (
            <span
              key={i}
              style={{
                width: 3.5,
                ...
                borderRadius: 2,
                background: "#A9C4FF",
                animation: `eq 1s ${i * 0.11}s ease-in-out infinite alternate`,
              }}
            />
          ))}
        </div>
      ...
      <button
        ...
        style={{
          ...
          alignItems: "center",
          gap: 9,
          boxShadow: "0 8px 20px rgba(240,68,56,.3)",
        }}
      >
        <span style={{ width: 9, height: 9, borderRadius: 2, background: "#fff" }} /> Stop &amp;
        Insert Transcript
      </button>
    </div>
  );
  ...
  return (
    <div
      style={{
        ...
        height: "100%",
        position: "relative",
        animation: "slideIn .32s cubic-bezier(.2,.8,.3,1)",
      }}
    >
      {voice && (
        <VoiceOverlay
          onStop={() => {
            setVoice(false);
            setReason(
              "58M in Room 404 with substernal chest pain radiating to the left arm, diaphoretic, BP 92/60, requesting urgent cardiology evaluation.",
            );
          }}
        />
      )}
        ...
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          >
              ...
              {facilityScope.map((id) => (
                <button
                  ...
                  style={{
                    ...
                    padding: "7px 13px",
                    borderRadius: 16,
                    color: facility === id ? "#fff" : FACILITIES[id].hue,
                    background: facility === id ? FACILITIES[id].hue : "#fff",
                    border: `1px solid ${FACILITIES[id].hue}44`,
                  }}
                >
                  {FACILITIES[id].name}
                </button>
            ...
            <div style={{ fontSize: 12.5, color: T.sub, marginTop: 10 }}>
              Chart writes back to <b style={{ color: T.ink }}>{f?.emr}</b> · Emergency Department
            </div>
          </div>
          ...
          >
            ...
            >
              <PersonIcon c={T.blue} /> Patient Information
            </div>
            <div
              style={{
                display: "flex",
              ...
              {["Existing Patient", "New Patient"].map((m) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 10.5,
                    background:
                      mode === m ? "linear-gradient(135deg,#2E5CFF,#1E3FCC)" : "transparent",
            ...
            <div style={{ fontSize: 14, fontWeight: 620, color: T.ink, margin: "15px 0 7px" }}>
              {mode === "Existing Patient" ? "Search patient *" : "Patient name *"}
            </div>
            <input
              value={patient}
            ...
            >
              ...
              >
                <svg width="12" height="12" viewBox="0 0 24 24" fill={T.blue}>
                  <rect x="9" y="3" width="6" height="11" rx="3" />
                  <path d="M6 11a6 6 0 0 0 12 0h-1.6a4.4 4.4 0 0 1-8.8 0H6Z" />
                </svg>{" "}
                Dictate
          ...
          >
            ...
            <div style={{ fontSize: 12.5, color: T.sub, marginTop: 3 }}>
              Three bars Critical · two Urgent · one Routine. The glyph travels with the message.
            </div>
            {suggestion && (
              <div
                style={{
              ...
              >
                ...
                <span style={{ fontSize: 13, color: T.ink, fontWeight: 560 }}>
                  ALIS suggests{" "}
                  <b style={{ color: ACUITY[suggestion.level].color }}>
                    {ACUITY[suggestion.level].label}
                  </b>{" "}
                  · {suggestion.confidence}% confidence
                </span>
                {acuity !== suggestion.level && (
                  <button
                    onClick={() => setAcuity(suggestion.level)}
                    style={{
                      all: "unset",
                      cursor: "pointer",
                      marginLeft: "auto",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: "13px 0 11px",
                      borderRadius: 16,
                      background: sel ? a.color + "14" : "#FAFBFC",
                      border: sel ? `1.5px solid ${a.color}` : "1px solid " + T.line,
                      transition: "all .2s ease",
                    }}
                  >
                    <div style={{ display: "flex", justifyContent: "center" }}>
                      <Glyph level={k} size={12} gap={2} w={5} />
                    </div>
                    <div
                      style={{
                        fontSize: 12.5,
                        fontWeight: 660,
                        color: sel ? a.color : T.sub,
                        marginTop: 7,
                      }}
                    >
                      {a.label}
                    ...
                    <div style={{ fontSize: 10.5, color: T.faint, marginTop: 2 }}>
                      {k === "critical" ? "5 min SLA" : k === "urgent" ? "30 min" : "4 hr"}
                    </div>
                  </button>
                );
              })}
          ...
          >
            ...
            <input
              ...
              style={{ ...inputStyle, borderRadius: 24, marginTop: 11 }}
            />
            <div
              style={{
                display: "flex",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      fontSize: 13,
                      fontWeight: sel ? 640 : 500,
                      color: sel ? "#fff" : T.ink,
                      background: sel ? "linear-gradient(135deg,#2E5CFF,#1E3FCC)" : "#F7F8FA",
                      border: "1px solid " + (sel ? "#1B3FA0" : T.line),
                      borderRadius: 18,
                      padding: "8px 14px",
            ...
            <button
              ...
              style={{
                ...
                gap: 11,
                marginTop: 15,
                background: telehealth ? "#EDF3FF" : "#FAFBFC",
                border: "1px solid " + (telehealth ? "#C9DBFF" : T.line),
                borderRadius: 16,
                padding: "12px 14px",
              }}
            >
              <span
                style={{
                  ...
                  height: 34,
                  borderRadius: 12,
                  background: telehealth ? T.blue : "#E7EAEF",
                  display: "inline-flex",
                  alignItems: "center",
                  justifyContent: "center",
                  flexShrink: 0,
              ...
              >
                <VideoIcon c={telehealth ? "#fff" : T.sub} />
              </span>
              <span style={{ flex: 1 }}>
                <span style={{ display: "block", fontSize: 14, fontWeight: 640, color: T.ink }}>
                  Request telehealth visit
                </span>
                <span style={{ display: "block", fontSize: 12, color: T.sub, marginTop: 1 }}>
                  Opens a secure video room with the on-call specialist
                </span>
              </span>
              <span
                style={{
                  ...
                  height: 24,
                  borderRadius: 12,
                  background: telehealth ? T.blue : "#D8DDE6",
                  position: "relative",
                  flexShrink: 0,
          ...
          <button
            ...
            style={{
              ...
              textAlign: "center",
              marginTop: 18,
              background: ready ? "linear-gradient(135deg,#2E5CFF,#1E3FCC)" : T.ghost,
              color: ready ? "#fff" : T.faint,
              fontSize: 16,
              fontWeight: 660,
              borderRadius: 17,
              padding: "16px 0",
              boxShadow: ready ? "0 8px 22px rgba(41,112,255,.3)" : "none",
        ...
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              />
              <span style={{ fontSize: 17.5, fontWeight: 700, color: T.ink, letterSpacing: -0.3 }}>
                {t.patient}
              </span>
            ...
            >
              {[
                ...
                <div key={l}>
                  ...
                  <div style={{ fontSize: 15, color: T.ink, fontWeight: 560, marginTop: 3 }}>
                    {v}
                  </div>
                </div>
              ))}
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                <div style={{ fontSize: 14.5, color: T.ink, lineHeight: 1.5, marginTop: 4 }}>
                  {t.reason || "—"}
                </div>
              </div>
            </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 9, flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: 16, fontWeight: 680, color: T.ink }}>
                ALIS AI™ Clinical Analysis
              </span>
              <span
                style={{
                  marginLeft: "auto",
              ...
              >
                {t.confidence || 90}% confidence
              </span>
            </div>
            <div style={{ fontSize: 12.5, color: T.sub, marginTop: 10, lineHeight: 1.5 }}>
              Acuity recommendation:{" "}
              <span style={{ fontWeight: 650, color: ACUITY[t.acuity].color }}>
                {ACUITY[t.acuity].label}
              </span>{" "}
              — based on presenting symptoms, vitals trend, and service-line routing rules. The
              final acuity is always the sending clinician's call.
            </div>
            <div
              style={{
                background: "#FAFBFC",
            ...
            >
              {sent ? (
                <div style={{ textAlign: "center", padding: "8px 0", animation: "rise .3s ease" }}>
                  ...
                  <div style={{ fontSize: 14.5, fontWeight: 650, color: T.green, marginTop: 2 }}>
                    Feedback submitted
                  </div>
                  <div style={{ fontSize: 12.5, color: T.sub, marginTop: 3 }}>
                    Thank you — this trains ALIS on your clinical judgment.
                  </div>
                </div>
              ) : (
                <>
                  <div style={{ fontSize: 14.5, fontWeight: 650, color: T.ink }}>
                    How accurate was the AI recommendation?
                  </div>
                  <div style={{ display: "flex", gap: 8, marginTop: 11 }}>
                    {[
                      ["correct", "✓ Correct", T.green],
                      ["partial", "△ Partial", T.amber],
                      ["incorrect", "✕ Incorrect", T.red],
                    ].map(([k, l, c]) => (
                      <button
                        key={k}
                        onClick={() => setFb(k)}
                        style={{
                          ...
                          fontWeight: 640,
                          color: fb === k ? c : T.sub,
                          background: fb === k ? c + "14" : "#fff",
                          border: fb === k ? `1.5px solid ${c}` : "1px solid " + T.line,
                          transition: "all .18s ease",
                        }}
                      >
                        {l}
                  ...
                  <textarea
                    ...
                    placeholder="Additional context or observations (optional)…"
                    rows={3}
                    style={{ ...inputStyle, resize: "vertical", marginTop: 11, fontSize: 13.5 }}
                  />
                  <button
                    disabled={!fb}
                    ...
                    style={{
                      all: "unset",
                      boxSizing: "border-box",
                      cursor: fb ? "pointer" : "default",
                      width: "100%",
                      textAlign: "center",
                      marginTop: 11,
                      background: fb ? "linear-gradient(135deg,#2E5CFF,#1E3FCC)" : T.ghost,
                      color: fb ? "#fff" : T.faint,
                      fontSize: 14.5,
                      fontWeight: 650,
                      borderRadius: 14,
                      padding: "13px 0",
    ...
    <>
      <div style={{ padding: "18px 18px 10px" }}>
        ...
        >
          ...
          <span style={{ fontSize: 17, fontWeight: 700, color: T.ink, letterSpacing: -0.3 }}>
            August 2026
          </span>
          <svg
            width="18"
          ...
          return (
            <div
              ...
              style={{
                background: "#fff",
                borderRadius: 20,
                border: today ? "1.5px solid " + T.blue : "1px solid " + T.line,
                boxShadow: today
                  ? "0 8px 22px rgba(41,112,255,.1)"
                  : "0 2px 6px rgba(16,24,40,.04)",
                padding: 15,
                animation: `rise .3s ${i * 0.04}s ease backwards`,
              }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
                <span
                  style={{
                    ...
                    height: 34,
                    borderRadius: 12,
                    background: today ? "linear-gradient(135deg,#2E5CFF,#1E3FCC)" : "#F2F4F7",
          ...
          >
            <span
              style={{
                ...
                height: 34,
                borderRadius: 4,
                background: FACILITIES[c.facility].hue,
              }}
            />
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 14.5, fontWeight: 640, color: T.ink }}>
                {FACILITIES[c.facility].name}
              </div>
...
export function RoutingScreen({ payload }) {
  ...
  const steps = [
    ...
    {
      t: payload.telehealth ? "Telehealth room provisioned" : "Secure notification delivered",
      d: payload.telehealth
        ? "Patient invite sent · waiting room open"
        : "Read-receipt & escalation tracking active",
      delay: 1.8,
    },
  ];
  return (
    <div
      style={{
        ...
        inset: 0,
        zIndex: 70,
        background: "linear-gradient(180deg,#0E1A3E 0%,#12275E 55%,#1B3FA0 130%)",
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
        justifyContent: "center",
    ...
    >
      ...
      >
        Routing your consult to {FACILITIES[payload.facility]?.name}
      </div>
      <div style={{ display: "flex", alignItems: "center", marginTop: 34 }}>
          ...
          {[0, 1, 2, 3, 4].map((i) => (
            <span
              ...
              style={{
                ...
                borderRadius: 3,
                background: "#8FB6FF",
                animation: `flow 1.2s ${i * 0.14}s ease-in-out infinite`,
              }}
            />
          ))}
        </div>
        <div
          style={{
            ...
            height: 74,
            borderRadius: "50%",
            background: "linear-gradient(135deg,#F2F6FE,#DCE7FA)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: 21,
            ...
            boxShadow: "0 0 30px rgba(143,182,255,.4)",
          }}
        >
          EV
        </div>
        ...
        {steps.map((s) => (
          <div
            ...
            style={{
              ...
              gap: 12,
              animation: `rise .4s ${s.delay}s ease backwards`,
            }}
          >
            <span
              style={{
            ...
            >
              <svg
                ...
                style={{ animation: `fadeIn .3s ${s.delay + 0.3}s ease backwards` }}
              >
